    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsDescription", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarsDescription_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsPricing", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarsPricing_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarsPricing_Pricings_PricingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsDescription_CarId",
                table: "CarsDescription",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsPricing_CarId",
                table: "CarsPricing",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarsPricing_PricingId",
                table: "CarsPricing",
                column: "PricingId");
        }
